  ...
  <div class="dataTable-wrapper">
    <div class="table-responsive">
      <table class="table table-striped table-bordered table-hover" id="dataTables-example" width="100%" cellspacing="1" cellpadding="3">
        <tr>
          <td colspan="3" bgcolor="#CCCCCC"><strong>PERIODE PENGELUARAN </strong></td>
        </tr>
        <tr>
  ...
  <div class="table-responsive">
    <table class="table table-striped table-bordered table-hover" id="dataTables-example" width="100%" cellspacing="1" cellpadding="3">
      <tr>
        ...
        <td width="126" bgcolor="#CCCCCC"><strong>Obat Keluar </strong></td>
        <td width="250" bgcolor="#CCCCCC"><strong>Pelanggan </strong></td>
        <td width="354" bgcolor="#CCCCCC"><strong>Keterangan </strong></td>
      ...
      $myQry = mysqli_query($koneksidb, $mySql)  or die("Query 1 salah : " . mysqli_error($myQry));
      $nomor = $hal;
