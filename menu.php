...
?>
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			...
			<ul class="nav" id="side-menu">
				...
				<li>
					...
					<ul class="nav nav-second-level">
						<li><a href='?page=Tindakan-Data' title='Tindakan'>Data Diagnosa</a></li>
				...
				<li><a href='rawat-pasien/' title='Rawat Pasien'><i class="fa fa-share-square fa-fw"></i> Rawat Jalan Pasien</a> </li>
			...
			<li><a href="?page=Laporan-Penjualan-Periode">Laporan Obat/Periode</a></li>
			...
			<li><a href="?page=Laporan-Pendaftaran-Periode">//Laporan Pendaftaran/Periode</a></li>-->
						...
						<li><a href="?page=Laporan-Penjualan">Laporan Obat</a></li>
...
?>
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			...
			<ul class="nav" id="side-menu">
				<li><a href='?page' title='Halaman Utama'>Home</a></li>
				<li><a href='penjualan/index.php' title='Penjualan Apotek' target='_blank'>Pengeluaran Apotek</a> </li>
				<li><a href='?page=Logout' title='Logout (Exit)'>Logout</a></li>
			</ul>
