...
if (isset($_POST['btnSimpan'])) {
	...
	$dataLembaga =  $_POST['cmbLembaga'];
	$tahunajaran = $_POST['cmbThnAjaran'];
...
$dataLembaga =  isset($_POST['cmbLembaga']) ? $_POST['cmbLembaga'] : $myData['kode_lembaga'];
$tahunajaran = isset($_POST['cmbThnAjaran']) ? $_POST['cmbThnAjaran'] : $myData['tahun_ajaran'];
// Tempat, Tgl Lahir
			...
			<td>
				...
				<select name='cmbThnAjaran'>
					...
					for ($dataTahunAjaran = $thn_skr; $dataTahunAjaran >= 2010; $dataTahunAjaran--) {
						if ($dataTahunAjaran == $tahunajaran) {
							$cek1 = " selected";
						} else {
							$cek1 = "";
						}
					?>
						...
						<option value="<?php echo $dataTahunAjaran ?>" <?= $cek1 ?>><?php echo $dataTahunAjaran ?></option>
