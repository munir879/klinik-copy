...
if ($_GET) {
	...
	switch ($_GET['page']) {
		...
		case 'Pasien-Edit':
			...
			break;
		case 'Pasien-Upload':
			if (!file_exists("upload_pasien.php")) die("Sorry Empty Page!");
			include "upload_pasien.php";
			break;
		case 'Upload-Aksi':
			if (!file_exists("upload_aksi_pasien.php")) die("Sorry Empty Page!");
			include "upload_aksi_pasien.php";
			break;
		case 'Excel_Reader2':
			if (!file_exists("excel_reader2.php")) die("Sorry Empty Page!");
		...
		case 'Stok-Obat':
			if (!file_exists("obat_stok.php")) die("Sorry Empty Page!");
			include "obat_stok.php";
			break;

		case 'Stoke-ajax':
			if (!file_exists("Stoke-ajax.php")) die("Sorry Empty Page!");
			include "Stoke-ajax.php";
			break;
		...
		case 'Laporan-Penjualan-Periode':
			...
			include "laporan_penjualan_periode.php";
			break;
